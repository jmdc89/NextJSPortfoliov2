    ...
    >
      ...
      <motion.div
        ...
        <svg
            ...
            className="h-5 w-5 fill-black dark:fill-gray-400 dark:hover:fill-[#F7AB0A] hover:fill-blue-900"
            fill="currentColor"
            viewBox="0 0 24 24">
            <path
        ...
        <svg 
          className="h-6 w-6 text-black dark:text-gray-400 hover:text-blue-900 dark:hover:text-[#F7AB0A]"
